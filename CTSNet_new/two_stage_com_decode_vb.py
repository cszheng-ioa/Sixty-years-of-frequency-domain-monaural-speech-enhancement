...
def enhance(args):
    ...
    model1.load_state_dict(torch.load('./BEST_MODEL/step1_vb_cts_cprs_model_final.pth'))
    model2.load_state_dict(torch.load('./BEST_MODEL/step2_vb_cts_cprs_model.pth'))
    model1.cuda().eval()
    model2.cuda().eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--esti_file_path', type=str, default='./datasets/vb_cts_cprs_model_new')
